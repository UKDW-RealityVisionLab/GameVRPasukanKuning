...
public class AIBehaviour : MonoBehaviour
{
    ...
    //IEnumerator RunRoutineByRole()
    //{
    //    yield return new WaitForSeconds(1f); // biar animator sempat reset

    //    switch (roleAi)
    //    {
    //        case "Seller":
    //            yield return SellerRoutine();
    //            break;

    //        case "Crafter":
    //            yield return CrafterRoutine();
    //            break;

    //        case "infoHelper":
    //            yield return InfoHelperRoutine();
    //            break;
    //    }
    //}

    //IEnumerator SellerRoutine()
    //{
    //    animator.SetTrigger("IsExit");
    //    stateMachine.ChangeState(idleState);
    //    idleState.ChangeSubState(new ArrangeStuffState(stateMachine, idleState, this, targetNataBarang.position));
    ...
    //IEnumerator InfoHelperRoutine()
    //{
    //    animator.SetTrigger("IsExit");
    //    stateMachine.ChangeState(idleState);
    //    idleState.ChangeSubState(new SellState(stateMachine, idleState, this, targetCustomer.position));
    //    guidanceState.SetCondition("IsIdleNother");
